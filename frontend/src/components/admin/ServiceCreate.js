...
const ServiceCreate = () => {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      try {
        ...
        const providersRes = await axios.get('http://localhost:5000/admin/providers', { headers });
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('http://localhost:5000/admin/services', serviceData, { headers });
      ...
      for (const variant of data.variants) {
        ...
        await axios.post(`http://localhost:5000/admin/services/${serviceId}/variants`, variantData, { headers });
      }
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Create Service</h2>
